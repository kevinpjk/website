                        ...
                        <Row>
                            <Col>
                                ...
                                <ul>
                                    ...
                                    <li>Implemented pick-up items, for example ramen soup, and obstcales, such as school bus and evil snowman for more variety and fun!</li>
                                </ul>
                                <p></p>
                            </Col>
                            ...
                            <Col>
                                <Carousel>
                                    <Carousel.Item>
                                        <Image src={endless_runner1} alt="Endless Runner 1" rounded style={{width:447, height:266}}/>
                                        <Carousel.Caption className="caption">
                                            <p>Start screen of the game</p>
                                        </Carousel.Caption>
                                    </Carousel.Item>
                                    <Carousel.Item>
                                        <Image src={endless_runner2} alt="Endless Runner 2" rounded style={{width:447, height:266}}/>
                                        <Carousel.Caption className="caption">
                                            <p>Character running on platform</p>
                                        </Carousel.Caption>
                                    </Carousel.Item>
                                    <Carousel.Item>
                                        <Image src={endless_runner3} alt="Endless Runner 3" rounded style={{width:447, height:266}}/>
                                        <Carousel.Caption className="caption">
